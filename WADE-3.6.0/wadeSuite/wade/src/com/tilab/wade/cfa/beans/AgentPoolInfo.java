...
public class AgentPoolInfo extends AgentBaseInfo {

	private static final long serialVersionUID = -331766907953028554L;
	...
	public SortedMap<String, String> getParametersForComparison() {
		...
		result.put("size", Integer.toString(getSize()));
		return result;
	}
}
