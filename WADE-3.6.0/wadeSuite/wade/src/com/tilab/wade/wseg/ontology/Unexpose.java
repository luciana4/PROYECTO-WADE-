...
public class Unexpose implements AgentAction {

	private static final long serialVersionUID = 252426570095449805L;
	...
	public Unexpose(String servicesArchiveName) {
	...
	public String toString() {
		return "Unexpose [servicesArchiveName=" + servicesArchiveName + "]";
	}
}
