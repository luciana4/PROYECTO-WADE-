...
public class GetPendingExecutionsBehaviour extends EngineProxyBehaviour<GetPendingExecutions, List<WorkflowExecutionInfo>> {

	public GetPendingExecutionsBehaviour(String requester) {
		super(new GetPendingExecutions(requester), WorkflowStatusOntology.getInstance(), null);
