...
public class KillWorkflowBehaviour extends EngineProxyBehaviour<KillWorkflow, Void> {

	private AID executor;
	
	public KillWorkflowBehaviour(AID executor, String executionId, boolean freeze, int scope, String message) {
		super(null, WorkflowManagementOntology.getInstance(), null);

		this.executor = executor;
		
		KillWorkflow kw = new KillWorkflow(executionId);
		kw.setFreeze(freeze);
		kw.setScope(scope);
		kw.setMessage(message);
		setAction(kw);
	}
