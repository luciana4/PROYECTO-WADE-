...
//#ANDROID_EXCLUDE_END
public class MandatoryConstraint extends ConstraintImpl {

	private static final long serialVersionUID = -2033342178691902849L;
	...
	public void validate(Object value) throws ConstraintException {
		if (value == null || value instanceof AbsVariable) {
			throw new ConstraintException("Mandatory violated", this);
		}
	}
}
