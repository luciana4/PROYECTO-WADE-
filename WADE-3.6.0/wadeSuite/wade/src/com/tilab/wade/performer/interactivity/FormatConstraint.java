...
//#ANDROID_EXCLUDE_END
public class FormatConstraint extends ConstraintImpl {

	private static final long serialVersionUID = 5021745731189551900L;

	private String format;
	
	protected FormatConstraint() {
	...
	public void validate(Object value) throws ConstraintException {
		// FIX-ME: format syntax is user-specific -> no validate
	}
}
