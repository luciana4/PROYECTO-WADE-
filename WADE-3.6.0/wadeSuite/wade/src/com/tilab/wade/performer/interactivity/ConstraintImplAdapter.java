...
//#ANDROID_EXCLUDE_END
class ConstraintImplAdapter extends XmlAdapter<ConstraintImpl,Constraint> {
	public Constraint unmarshal(ConstraintImpl v) { return v; }

	public ConstraintImpl marshal(Constraint v) { return (ConstraintImpl)v; }
}
